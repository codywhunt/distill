...
/// Generated utility to access Material icons by name.
/// Uses a Map lookup instead of switch for faster performance and
/// to avoid Dart JIT compiler stack overflow on large switch statements.
class IconHelper {
  /// Internal map from icon name to IconData
  ...
  /// Get an IconData by its name
  static IconData? getIconByName(String name) => _iconMap[name];

  /// Get all available icon names (curated list for UI)
